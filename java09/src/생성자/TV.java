...
//	}
	// 객체 생성할 때마다 꼭 실행시키고 싶은 내용이 있으면 기본 생성자를 눈에 보이게 다시 만들어주세요. (명시적으로)
	// 메뉴 : source -> generate constructors from superclass 클릭
	public TV() {
...
//	}
	...
	// 자동완성
	// 메뉴 : source ->  generate constructors using Fields
